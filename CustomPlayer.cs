...
namespace SimpleFPS
{
    public class CustomPlayer : Player
    {
        ...
        public override void Spawned()
        {
            ...
            base.Spawned();
            startRotaion = KCC.TransformRotation;
    ...
    if (AttitudeSensor.current != null)
    {
        ...
        protected override void ProcessInput(NetworkedInput input)
        {
            ...
            KCC.AddLookRotation(lookDelta, -16f, 60f);
            ...
            // ─────────────────────
            float pitch = KCC.TransformRotation.eulerAngles.x;
            ...
            // Movement
            // ─────────────────────
            var inputDirection = startRotaion * new Vector3(input.MoveDirection.x, 0f, input.MoveDirection.y);
        ...
        public void RPC_SetReady(bool isture)
        {
            ...
            // Only Server should check both ready
            //  if (Object.HasStateAuthority)
...
namespace SimpleFPS
{
    ...
    public class CustomPlayer : Player
    {
        ...
        protected override void ProcessInput(NetworkedInput input)
        {
            ...
            if(input.Buttons.IsSet(EInputButton.GyroStart))
            {
                var startXRot = KCC.TransformRotation.eulerAngles.x;
                var offset = input.LookRotationStart.y - 75;
                if (input.LookRotationStart.y > 180)
                    offset -= 360;
                offset = Mathf.Clamp(offset, -89, 89);
                KCC.SetLookRotation(startXRot - offset, KCC.TransformRotation.eulerAngles.y, -89f, 89f);
            }
